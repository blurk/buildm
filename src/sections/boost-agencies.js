					...
					<Flex sx={styles.col}>
						<Box sx={styles.content}>
							<Box sx={styles.titleBox}>
								<Heading as='h3'>
									Tăng cường phát triển website của bạn bằng cách chọn nhà phát
									triển
								</Heading>
								<Text as='p'>
									Tạo ra những trang landing pages, những website cá nhân, đầu
									tư,..với số lượng nhiều khách hàng truy cập
								</Text>
							</Box>
							<Box as='ul' sx={styles.list}>
								<Text as='li'>
									<IoIosCheckmarkCircle />
									Khả năng thiết kế không giới hạn
								</Text>
								<Text as='li'>
									<IoIosCheckmarkCircle />
