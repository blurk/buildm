          ...
          <Flex sx={styles.col}>
            <Box sx={styles.content}>
              <Box sx={styles.titleBox}>
                <Heading as='h3'>
                  Boost your website by choosing Ninja Developers
                </Heading>
                <Text as='p'>
                  Create custom landing pages, personal websites, portfolio...
                  with us that convert more visitors than any website.
                </Text>
              </Box>
