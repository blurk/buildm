...
const FeatureData = [
  {
    ...
    title: 'Ladi Page',
    description:
      'VVECO design landing page was made with NextJS & Framer-motion',
  ...
  },
  {
    ...
    description:
      "Eastgate Software's homepage was built with NextJS & Strapi as Back-end",
    path: 'https://eastgate-software.com/',
  },
  {
    image: featureImage3,
    title: 'Melriver home page',
    description: 'We rebuilt the home page of Melriver Agency',
