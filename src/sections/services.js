...
const SERVICES_DATA = [
	{
		icon: icon1,
		title: 'Chuyên nghiệp',
		text: 'Chúng tôi là một đội gồm 1 Developer và 1 Tester'
	},
	{
		icon: icon2,
		title: 'Nhanh chóng',
		text: 'Chúng tôi xây dựng website trong một thời gian ngắn'
	},
	{
		icon: icon3,
		title: 'SEO',
	...
	},
	{
		...
		text: 'Chúng tôi sẽ tạo ra 1 tác phẩm nghệ thuật'
	}
]
...
const Services = () => {
	return (
		<Box sx={styles.services} id='services'>
			<Container>
				<BlockTitle
					slogan='Tính năng chất lượng'
					title='Những tính năng chất lượng của dịch vụ'
