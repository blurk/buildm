...
const SERVICES_DATA = [
  {
    ...
    text: 'We are a team of 1 Web Developer and 1 Tester',
  },
  {
    icon: icon2,
    title: 'Fast Development',
    text: 'We build your site with in a short time',
  },
  {
    icon: icon3,
    title: 'SEO & Accessibility',
    text: 'Website has SEO & Accessibility standard',
  },
  {
    icon: icon4,
    title: 'Best Award history',
    text: 'We will make your website a piece of art',
  },
]
    ...
    <Box sx={styles.services} id='services'>
      <Container>
        <BlockTitle
          ...
          title='Meet exciting features of our service'
